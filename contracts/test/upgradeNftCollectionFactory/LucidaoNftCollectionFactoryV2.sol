...
import "./LucidaoNftCollectionV2.sol";
...
contract LucidaoNftCollectionFactoryV2 is Initializable, OwnableUpgradeable {
	using EnumerableSetUpgradeable for EnumerableSetUpgradeable.AddressSet;

	struct CreatedContract {
		LucidaoNftCollectionV2 collection;
		string symbol;
		string name;
		address oracle;
		bytes1 tokenVersion;
	...
	function createCollection(
		...
		LucidaoNftCollectionV2 collection = new LucidaoNftCollectionV2(_name, _symbol, _oracle, msg.sender, nftReserveAddress, _minGracePeriod, _insolvencyGracePeriod,  sellDeadline);
